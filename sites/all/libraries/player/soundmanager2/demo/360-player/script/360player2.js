...
function ThreeSixtyPlayer() {
  ...
  this.config = {
    ...
    loadRingColor: '#FFFFFF', // how much has loaded
    playRingColor: '#FFFFFF', // how much has played
    ...
    waveformDataDownsample: 16, // use only one in X (of a set of 256 values) - 1 means all 256
    ...
    scaleArcWidth: 0.1,  // thickness factor of playback progress ring
  ...
  this.handleClick = function(e) {
    ...
    thisSound = self.getSoundByURL(soundURL);
      ...
      // already exists
      if ((thisSound) && thisSound === self.lastSound) {
